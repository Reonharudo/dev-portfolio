        ...
        <section id="about" className={styles.container}>
            <div className={styles.description_container}>
                ...
                <p>
                    ...
                    drives continuous improvement in our rapidly evolving field.
                </p>

                <p>
                    Beyond my software engineering endeavours, I am a hardware
                    enthusiast as you may see on the pictures on your right :){" "}
                    <br />
